    ...
    <div className="footer-distributed">
            <div className="footer-left">
                ...
                <p className="footer-links">
                    ...
                    <a href="https://linktr.ee/ecell.medicaps">Register Now</a>
                </p>
            </div>
            ...
            <div className="footer-right">
                ...
                <div className="footer-icons">
                    ...
                    <a href="https://www.instagram.com/medicaps_ecell/"><FaInstagram /></a> 
                    <a href="www.linkedin.com/in/e-cell-medi-caps-university"><FaLinkedin /></a> 
